...
public final class QueryUtils {
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        List<Earthquake> earthquake = extractEarthquakesJson(jsonResponse);
    ...
    */
     ...
     */
    public static List<Earthquake> extractEarthquakesJson(String earthquakeJSON) {
        ...
        try {
            ...
            JSONObject mJson = new JSONObject(earthquakeJSON);
            JSONArray features = mJson.getJSONArray("features");
            ...
            for (int i = 0; i < features.length();i++){
                ...
                */
                ...
                Earthquake earthquake = new Earthquake(magnetude,location,timeInMilliseconds,url);
